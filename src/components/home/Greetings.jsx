...
const Greetings = () => {
  ...
  return (
    <div className="flex justify-between items-center">
        <div>
            <h1 className="text-[#f5f5f5] text-2xl font-semibold tracking-wide">Good Morning, Mandar</h1>
            <p className="text-[#ababab] text-sm">Give your best services for customers </p>
        </div>
        <div>
            <h1 className="text-[#f5f5f5] text-3xl font-semibold tracking-wide">{formatTime(dateTime)}</h1>
